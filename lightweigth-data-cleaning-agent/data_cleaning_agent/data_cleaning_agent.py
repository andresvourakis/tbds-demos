...
def make_lightweight_data_cleaning_agent(
    ...
    def generate_data_cleaner_code(state: GraphState):
        """
    ...
    # Add nodes
    workflow.add_node("generate_data_cleaner_code", generate_data_cleaner_code)
    ...
    # Set entry point
    workflow.set_entry_point("generate_data_cleaner_code")
    
    # Add edges
    workflow.add_edge("generate_data_cleaner_code", "execute_data_cleaner_code")
